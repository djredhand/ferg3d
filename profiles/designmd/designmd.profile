...
function designmd_form_install_configure_form_alter(&$form, $form_state) {
  $form['site_information']['site_name']['#default_value'] = t('Designmd');
...
function _wr_profile_install_configure_form_submit($form, &$form_state) {
  ...
  drupal_set_message("Your Designmd Drupal installation was successful.");
